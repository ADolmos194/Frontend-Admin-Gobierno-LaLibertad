...
var mercado_service_1 = require("@/apis_modelos/general/mercado_service/mercado.service");
...
var Mercado = /** @class */ (function () {
    ...
    Mercado.prototype.onGlobalFilter = function (table, event) {
        table.filterGlobal(event.target.value, 'contains');
    };
    Mercado.prototype.cargarMercados = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.mercadoService.getMercados()];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error al cargar los mercados', error_1);
                        return [3 /*break*/, 4];
    ...
    Mercado.prototype.cargarOpciones = function (service, opcionesRef, label) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Mercado.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        error_3 = _a.sent();
                        console.error('Error al cargar los mercados:', error_3);
                        return [3 /*break*/, 6];
                    case 5:
                        this.isLoading = false;
                        return [7 /*endfinally*/];
    ...
    Mercado.prototype.abrirNuevo = function () {
        this.accion = 1;
        this.enviar = false;
        this.limpiarDatos();
        this.mercadoDialogo = true;
    };
    Mercado.prototype.limpiarDatos = function () {
        this.mercado = {
            id: 0,
            nombre: '',
            estado_id: 1,
    ...
    Mercado.prototype.ocultarDialogo = function () {
        this.mercadoDialogo = false;
        this.enviar = false;
    };
    Mercado.prototype.guardarMercado = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var MercadoParaEnviar, response, _c, error_4, msg;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.mercadoService.createMercado(MercadoParaEnviar)];
                    case 2:
                        _c = _d.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.mercadoService.updateMercado(this.mercado.id, MercadoParaEnviar)];
                    case 4:
                        _c = _d.sent();
                        _d.label = 5;
                    case 5:
    ...
    Mercado.prototype.getEstado = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'ACTIVO';
            case 2:
    ...
    Mercado.prototype.getEstadoSeverity = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'success';
            case 2:
    ...
    Mercado.prototype.editarMercado = function (mercado) {
        this.mercado = __assign({}, mercado);
        this.accion = 2;
        this.mercadoDialogo = true;
    };
    ...
    Mercado = __decorate([
        core_1.Component({
            ...
            providers: [api_1.MessageService, mercado_service_1.MercadoService, api_1.ConfirmationService]
        })
    ], Mercado);
    return Mercado;
}());
