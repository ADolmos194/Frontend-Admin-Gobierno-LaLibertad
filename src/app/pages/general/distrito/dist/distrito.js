...
var distrito_service_1 = require("@/apis_modelos/general/distrito_servcie/distrito.service");
var Distrito = /** @class */ (function () {
    function Distrito(provinciaService, distritoService, messageService, estadoService, confirmationService) {
        this.provinciaService = provinciaService;
        this.distritoService = distritoService;
        this.messageService = messageService;
        this.estadoService = estadoService;
        this.confirmationService = confirmationService;
        this.distritoDialogo = false;
        this.distritos = core_1.signal([]);
        this.distrito = {
            id: 0,
            nombre: '',
            provincia_id: 0,
    ...
    Distrito.prototype.onGlobalFilter = function (table, event) {
        table.filterGlobal(event.target.value, 'contains');
    };
    Distrito.prototype.cargarDistritos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.distritoService.getDistritos()];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error al cargar los distritos', error_1);
                        return [3 /*break*/, 4];
    ...
    Distrito.prototype.cargarOpciones = function (service, opcionesRef, label) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Distrito.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.cargarDistritos()];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5:
                        error_3 = _a.sent();
                        console.error('Error al cargar los distritos:', error_3);
                        return [3 /*break*/, 7];
                    case 6:
                        this.isLoading = false;
                        return [7 /*endfinally*/];
    ...
    Distrito.prototype.abrirNuevo = function () {
        this.accion = 1;
        this.enviar = false;
        this.limpiarDatos();
        this.distritoDialogo = true;
    };
    Distrito.prototype.limpiarDatos = function () {
        this.distrito = {
            id: 0,
            nombre: '',
            provincia_id: 0,
    ...
    Distrito.prototype.ocultarDialogo = function () {
        this.distritoDialogo = false;
        this.enviar = false;
    };
    Distrito.prototype.guardarDistrito = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var DistritoParaEnviar, response, _c, error_4, msg;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        DistritoParaEnviar = {
                            ...
                            provincia: this.distrito.provincia_id,
                            estado: this.distrito.estado_id,
                            fecha_creacion: this.distrito.fecha_creacion,
                            fecha_modificacion: this.distrito.fecha_modificacion
                        };
                        if (!(this.accion === 1)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.distritoService.createDistrito(DistritoParaEnviar)];
                    case 2:
                        _c = _d.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.distritoService.updateDistrito(this.distrito.id, DistritoParaEnviar)];
                    case 4:
                        _c = _d.sent();
                        _d.label = 5;
                    case 5:
    ...
    Distrito.prototype.getEstado = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'ACTIVO';
            case 2:
    ...
    Distrito.prototype.getEstadoSeverity = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'success';
            case 2:
    ...
    Distrito.prototype.editarDistrito = function (distrito) {
        this.distrito = __assign({}, distrito);
        this.accion = 2;
        this.distritoDialogo = true;
    };
    Distrito.prototype.eliminarDistrito = function (distrito) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.confirmationService.confirm({
                    message: "\u00BFEst\u00E1s seguro de que deseas eliminar el distrito\"" + distrito.nombre + "\"?",
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.provinciaService.deleteProvincia(distrito.id)];
                                case 2:
                                    response = _c.sent();
                    ...
                    reject: function () {
                        _this.messageService.add({ severity: 'info', summary: 'Cancelado', detail: 'No se eliminó el distrito' });
                    }
                });
                return [2 /*return*/];
            });
    ...
    Distrito = __decorate([
        core_1.Component({
            ...
            templateUrl: './distrito.components.html',
            providers: [api_1.MessageService, distrito_service_1.DistritoService, api_1.ConfirmationService]
        })
    ], Distrito);
    return Distrito;
}());
