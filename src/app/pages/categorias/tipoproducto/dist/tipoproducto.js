...
var tipoproducto_service_1 = require("@/apis_modelos/categorias/tipoproducto_service/tipoproducto.service");
var Tipoproducto = /** @class */ (function () {
    function Tipoproducto(messageService, estadoService, tipoproductoService, confirmationService) {
        this.messageService = messageService;
        this.estadoService = estadoService;
        this.tipoproductoService = tipoproductoService;
        this.confirmationService = confirmationService;
        this.tipoproductoDialogo = false;
        this.tiposproductos = core_1.signal([]);
        this.tipoproducto = {
            id: 0,
            nombre: '',
            estado_id: 1,
    ...
    Tipoproducto.prototype.onGlobalFilter = function (table, event) {
        table.filterGlobal(event.target.value, 'contains');
    };
    Tipoproducto.prototype.cargarProductos = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.tipoproductoService.getTipoProducto()];
                    case 2:
                        response = _a.sent();
                        this.tiposproductos.set(response);
                        return [3 /*break*/, 4];
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error al cargar los tipos de productos', error_1);
                        return [3 /*break*/, 4];
    ...
    Tipoproducto.prototype.cargarOpciones = function (service, opcionesRef, label) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Tipoproducto.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.isLoading = true;
                        this.cols = [
                            { field: 'nombre', header: 'Tipo de producto' },
                    ...
                    case 4:
                        error_3 = _a.sent();
                        console.error('Error al cargar los tipos de productos:', error_3);
                        return [3 /*break*/, 6];
                    case 5:
                        this.isLoading = false;
                        return [7 /*endfinally*/];
    ...
    Tipoproducto.prototype.abrirNuevo = function () {
        this.accion = 1;
        this.enviar = false;
        this.limpiarDatos();
        this.tipoproductoDialogo = true;
    };
    Tipoproducto.prototype.limpiarDatos = function () {
        this.tipoproducto = {
            id: 0,
            nombre: '',
            estado_id: 1,
    ...
    Tipoproducto.prototype.ocultarDialogo = function () {
        this.tipoproductoDialogo = false;
        this.enviar = false;
    };
    Tipoproducto.prototype.guardarTipoProducto = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var TipoProductoParaEnviar, response, _c, error_4, msg;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        TipoProductoParaEnviar = {
                            id: this.tipoproducto.id,
                            nombre: this.tipoproducto.nombre,
                            estado: this.tipoproducto.estado_id,
                            fecha_creacion: this.tipoproducto.fecha_creacion,
                            fecha_modificacion: this.tipoproducto.fecha_modificacion
                        };
                        if (!(this.accion === 1)) return [3 /*break*/, 3];
                        return [4 /*yield*/, this.tipoproductoService.createTipoProducto(TipoProductoParaEnviar)];
                    case 2:
                        _c = _d.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.tipoproductoService.updateTipoProducto(this.tipoproducto.id, TipoProductoParaEnviar)];
                    case 4:
                        _c = _d.sent();
                        _d.label = 5;
                    case 5:
    ...
    Tipoproducto.prototype.getEstado = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'ACTIVO';
            case 2:
    ...
    Tipoproducto.prototype.getEstadoSeverity = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'success';
            case 2:
    ...
    Tipoproducto.prototype.editarTipoProducto = function (tipoproducto) {
        this.tipoproducto = __assign({}, tipoproducto);
        this.accion = 2;
        this.tipoproductoDialogo = true;
    };
    Tipoproducto.prototype.eliminarTipoProducto = function (tipoproducto) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.confirmationService.confirm({
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.tipoproductoService.deleteTipoProducto(tipoproducto.id)];
                                case 2:
                                    response = _c.sent();
                    ...
                    reject: function () {
                        _this.messageService.add({ severity: 'info', summary: 'Cancelado', detail: 'No se eliminó el tipo de producto' });
                    }
                });
                return [2 /*return*/];
            });
    ...
    Tipoproducto = __decorate([
        core_1.Component({
            ...
            templateUrl: './tipoproducto.components.html',
            providers: [api_1.MessageService, tipoproducto_service_1.TipoProductoService, api_1.ConfirmationService]
        })
    ], Tipoproducto);
    return Tipoproducto;
}());
