...
var producto_service_1 = require("@/apis_modelos/categorias/producto_service/producto.service");
var Producto = /** @class */ (function () {
    function Producto(productoService, messageService, estadoService, tipoproductoService, confirmationService) {
    ...
    Producto.prototype.onGlobalFilter = function (table, event) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.productoService.getProductos()];
                    case 2:
                        response = _a.sent();
                    ...
                    case 3:
                        error_1 = _a.sent();
                        console.error('Error al cargar los productos', error_1);
                        return [3 /*break*/, 4];
    ...
    Producto.prototype.cargarOpciones = function (service, opcionesRef, label) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Producto.prototype.ngOnInit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.all([this.cargarOpciones(this.tipoproductoService.getTipoProductoActivos.bind(this.tipoproductoService), this.opcionesTipoProducto, 'tipo producto activo')])];
                    case 2:
                        _a.sent();
                    ...
                    case 5:
                        error_3 = _a.sent();
                        console.error('Error al cargar los productos:', error_3);
                        return [3 /*break*/, 7];
                    case 6:
                        this.isLoading = false;
                        return [7 /*endfinally*/];
    ...
    Producto.prototype.abrirNuevo = function () {
        this.accion = 1;
        this.enviar = false;
        this.limpiarDatos();
        this.productoDialogo = true;
    };
    Producto.prototype.limpiarDatos = function () {
        this.producto = {
            id: 0,
            nombre: '',
            tipoproducto_id: 0,
    ...
    Producto.prototype.ocultarDialogo = function () {
        this.productoDialogo = false;
        this.enviar = false;
    };
    Producto.prototype.guardarProducto = function () {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var ProductoParaEnviar, response, _c, error_4, msg;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.productoService.createProducto(ProductoParaEnviar)];
                    case 2:
                        _c = _d.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, this.productoService.updateProducto(this.producto.id, ProductoParaEnviar)];
                    case 4:
                        _c = _d.sent();
                        _d.label = 5;
                    case 5:
    ...
    Producto.prototype.getEstado = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'ACTIVO';
            case 2:
    ...
    Producto.prototype.getEstadoSeverity = function (estado_id) {
        switch (estado_id) {
            case 1:
                return 'success';
            case 2:
    ...
    Producto.prototype.editarProducto = function (producto) {
        this.producto = __assign({}, producto);
        this.accion = 2;
        this.productoDialogo = true;
    };
    Producto.prototype.eliminarProducto = function (producto) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.confirmationService.confirm({
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                ...
                                case 1:
                                    ...
                                    return [4 /*yield*/, this.productoService.deleteProducto(producto.id)];
                                case 2:
                                    response = _c.sent();
                    ...
                    reject: function () {
                        _this.messageService.add({ severity: 'info', summary: 'Cancelado', detail: 'No se eliminó el producto' });
                    }
                });
                return [2 /*return*/];
            });
    ...
    Producto = __decorate([
        core_1.Component({
            ...
            providers: [api_1.MessageService, producto_service_1.ProductoService, api_1.ConfirmationService]
        })
    ], Producto);
    return Producto;
}());
