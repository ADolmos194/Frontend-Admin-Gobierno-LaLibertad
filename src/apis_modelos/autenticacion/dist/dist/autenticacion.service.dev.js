...
exports.endpoints = {
  ...
  actualizarUsuarioSistema: function actualizarUsuarioSistema(id) {
    return "autenticacion/usuariosistema/actualizar/" + id + "/";
  },
  eliminarUsuarioSistema: function eliminarUsuarioSistema(id) {
    return "autenticacion/usuariosistema/eliminar/" + id + "/";
  }
};

var UsuarioSistemaService =
/** @class */
function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.axiosIns.post("" + exports.url + exports.endpoints.verificacionusuariosistema, data)];
          ...
          case 1:
            ...
            if (access && refresh && userData.email) {
              this.cookie.set('access_token', access);
              this.cookie.set('refresh_token', refresh);
              this.cookie.set('userData', encodeURIComponent(JSON.stringify(userData)));
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.axiosIns.get("" + exports.url + exports.endpoints.usuariosistemas)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.axiosIns.post("" + exports.url + exports.endpoints.crearUsuarioSistema, data)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.axiosIns.put("" + exports.url + exports.endpoints.actualizarUsuarioSistema(id), data)];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , axios_1.axiosIns["delete"]("" + exports.url + exports.endpoints.eliminarUsuarioSistema(id))];
  ...
  UsuarioSistemaService = __decorate([core_1.Injectable({
    providedIn: 'root'
